summon interaction ~ ~ ~ {Tags:["chestm","bluerupee"],width:1.1f,height:1.1f}
...
execute store result score @e[type=item_display,stag=chestd,limit=1,sort=nearest] chestid run scoreboard players get . chestid
