summon interaction ~ ~ ~ {Tags:["chestm","caneofsomaria","big"],width:1.1f,height:1.1f}
...
summon item_display ~ ~ ~ {Tags:["chestd","big"],item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:164}},item_display:"thirdperson_righthand"}
