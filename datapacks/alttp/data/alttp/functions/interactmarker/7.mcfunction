...
execute if score # gameplay matches 12 if score firstbatch gameplay matches 1 if score 3 quests_2_progress matches 1 run scoreboard players set id dialogue 100
execute if score # gameplay matches 12 if score firstbatch gameplay matches 1 if score 3 quests_2_progress matches 2 run scoreboard players set id dialogue 111
execute if score # gameplay matches 12 if score firstbatch gameplay matches 1 if score 3 quests_2_progress matches 3 run scoreboard players set id dialogue 116
...
execute if score # gameplay matches 14 if score secondbatch gameplay matches 1 if score 6 quests_2_progress matches 5 run scoreboard players set id dialogue 314
