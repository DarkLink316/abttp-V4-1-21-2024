...
execute if score angle dialogue matches 20 if score cutscene dialogue matches 0 as @p at @s rotated as @e[type=area_effect_cloud,tag=dialogue_lock_aec,limit=1] run tp @s ~ ~ ~ ~ 20
execute if score angle dialogue matches 0 if score cutscene dialogue matches 0 as @p at @s rotated as @e[type=area_effect_cloud,tag=dialogue_lock_aec,limit=1] run tp @s ~ ~ ~ ~ 0
