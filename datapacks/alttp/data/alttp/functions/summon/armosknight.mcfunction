#Summon them all
summon armor_stand ~2 ~ ~1 {Marker:1b,Invisible:1b,Tags:["armosknight","enemyCode","enemy","ak1"],Pose:{RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:222}},{}],HurtByTimestamp:3}
...
summon armor_stand ~ ~ ~1 {Marker:1b,Invisible:1b,Tags:["armosknight","enemyCode","enemy","ak2"],Pose:{RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:222}},{}],HurtByTimestamp:3}
...
summon armor_stand ~-2 ~ ~1 {Marker:1b,Invisible:1b,Tags:["armosknight","enemyCode","enemy","ak3"],Pose:{RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:222}},{}],HurtByTimestamp:3}
...
summon armor_stand ~ ~ ~-1 {Marker:1b,Invisible:1b,Tags:["armosknight","enemyCode","enemy","ak4"],Pose:{RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:222}},{}],HurtByTimestamp:3}
...
summon armor_stand ~2 ~ ~-1 {Marker:1b,Invisible:1b,Tags:["armosknight","enemyCode","enemy","ak5"],Pose:{RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:222}},{}],HurtByTimestamp:3}
...
summon armor_stand ~-2 ~ ~-1 {Marker:1b,Invisible:1b,Tags:["armosknight","enemyCode","enemy","ak6"],Pose:{RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:222}},{}],HurtByTimestamp:3}
