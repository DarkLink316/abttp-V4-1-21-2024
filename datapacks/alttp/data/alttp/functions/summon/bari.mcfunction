summon armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,Tags:["bari","enemyCode","enemy","hookshotable"],Pose:{RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:92}},{}],HurtByTimestamp:6}
