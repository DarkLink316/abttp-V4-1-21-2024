...
execute if score @s enemydummy matches 1.. run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:208}},{}]}
...
execute if score @s enemydummy matches 160.. run particle block bone_block ~ ~ ~ 0.35 0.2 0.35 0 50 force
execute if score @s enemydummy matches 165.. run particle block bone_block ~ ~ ~ 0.34 0.5 0.34 0 50 force
execute if score @s enemydummy matches 170.. run particle block bone_block ~ ~ ~ 0.33 0.8 0.33 0 50 force
execute if score @s enemydummy matches 175.. run particle block bone_block ~ ~ ~ 0.32 1.1 0.32 0 50 force
execute if score @s enemydummy matches 180.. run particle block bone_block ~ ~ ~ 0.31 1.4 0.31 0 50 force
execute if score @s enemydummy matches 185.. run particle block bone_block ~ ~ ~ 0.30 1.7 0.30 0 50 force
execute if score @s enemydummy matches 190.. run particle block bone_block ~ ~ ~ 0.28 2 0.28 0 50 force
execute if score @s enemydummy matches 195.. run particle block bone_block ~ ~ ~ 0.25 2.1 0.25 0 50 force
...
execute if score @s enemydummy matches 0 if score @s enemydummy7 matches 0 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:205}},{}]}
...
execute if score @s enemydummy matches 0 if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 1..4 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:206}},{}]}
execute if score @s enemydummy matches 0 if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 5..8 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:207}},{}]}
...
execute if score @s enemydummy16 matches 1..2 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:209}},{}]}
execute if score @s enemydummy16 matches 3..4 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:210}},{}]}
execute if score @s enemydummy16 matches 5..6 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:211}},{}]}
execute if score @s enemydummy16 matches 7..8 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:212}},{}]}
execute if score @s enemydummy16 matches 8 run scoreboard players set @p set_damage 5
execute if score @s enemydummy16 matches 9..10 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:213}},{}]}
