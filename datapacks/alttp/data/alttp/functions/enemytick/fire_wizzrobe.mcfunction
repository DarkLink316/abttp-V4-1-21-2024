#FIND LINKED ENTITY
tag @s add link_a
execute as @e[type=zombie,tag=fire_wizzrobezo] if score @s enemylink = @e[type=armor_stand,tag=fire_wizzrobe,limit=1,sort=nearest] enemylink run tag @s add link_b
execute as @e[type=silverfish,tag=fire_wizzrobesf] if score @s enemylink = @e[type=armor_stand,tag=fire_wizzrobe,limit=1,sort=nearest] enemylink run tag @s add link_c
...
execute if score @s enemydummy matches 0 if entity @p[distance=..10] run function alttp:fire_wizzrobe_shoot
...
execute if score @s enemydummy2 matches 80 store result score result rand run random value 1..3
...
execute if score @s enemydummy9 matches 0 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:141}},{}]}
...
execute unless score @s enemydummy9 matches 0 if score @s enemydummy8 matches 1..5 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:142}},{}]}
execute unless score @s enemydummy9 matches 0 if score @s enemydummy8 matches 6..10 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:143}},{}]}

#SHOOTING ANIMATION
execute if score @s enemydummy matches ..1 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:146}},{}]}
execute if score @s enemydummy matches 2..5 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:145}},{}]}
execute if score @s enemydummy matches 6..9 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:144}},{}]}
