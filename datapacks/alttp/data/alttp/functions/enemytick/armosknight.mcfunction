...
execute if score @s enemydummy2 matches 18.. if entity @e[type=marker,tag=link_b,tag=final] run particle block sand ~ ~ ~ 2 0.2 2 0.35 50 force
...
#DAMAGE INDICATOR
execute if entity @e[type=slime,tag=link_hitbox,nbt={HurtTime:10s}] run particle block redstone_block ~ ~0.7 ~ 0 0 0 0.1 50 force
