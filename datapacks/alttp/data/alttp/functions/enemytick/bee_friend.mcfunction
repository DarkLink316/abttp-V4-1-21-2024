...
execute at @s unless score @s dummy matches 1.. if entity @e[type=bee,tag=!bee_friend,tag=!golden_bee_friend,tag=enemy,distance=..1.5] run damage @e[type=bee,tag=!bee_friend,tag=enemy,limit=1,sort=nearest,distance=0.1..,type=!armor_stand] 5
