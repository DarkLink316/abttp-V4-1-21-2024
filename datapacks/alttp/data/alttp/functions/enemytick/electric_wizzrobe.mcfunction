#FIND LINKED ENTITY
tag @s add link_a
execute as @e[type=zombie,tag=electric_wizzrobezo] if score @s enemylink = @e[type=armor_stand,tag=electric_wizzrobe,limit=1,sort=nearest] enemylink run tag @s add link_b
execute as @e[type=silverfish,tag=electric_wizzrobesf] if score @s enemylink = @e[type=armor_stand,tag=electric_wizzrobe,limit=1,sort=nearest] enemylink run tag @s add link_c
...
execute if entity @s[tag=link_init] unless entity @e[type=zombie,tag=link_b] run weather clear
...
execute if score @s enemydummy matches 0 if entity @p[distance=..10] run function alttp:electric_wizzrobe_shoot

execute if score @s enemydummy matches 1.. run scoreboard players remove @s enemydummy 1

#Bad weather
execute if entity @e[type=zombie,tag=link_b] if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run weather thunder
execute if entity @e[type=zombie,tag=link_b] if entity @p[distance=10..15] unless entity @s[tag=icerodfrozen] run weather clear

data merge entity @s {Fire:-20s}
data merge entity @e[type=zombie,tag=link_b,limit=1] {Fire:-20s}
data merge entity @e[type=silverfish,tag=link_c,limit=1] {Fire:-20s}

#TELEPORTY TELEPORTY?
scoreboard players add @s enemydummy2 1
execute if score @s enemydummy2 matches 80 store result score result rand run random value 1..2
execute if score @s enemydummy2 matches 80 if score result rand matches 1 as @e[type=silverfish,tag=link_c] at @s unless entity @s[tag=icerodfrozen] run function alttp:wizzrobetp
...
execute if score @s enemydummy9 matches 0 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:153}},{}]}
...
execute unless score @s enemydummy9 matches 0 if score @s enemydummy8 matches 1..5 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:154}},{}]}
execute unless score @s enemydummy9 matches 0 if score @s enemydummy8 matches 6..10 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:155}},{}]}

#SHOOTING ANIMATION
execute if score @s enemydummy matches ..1 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:158}},{}]}
execute if score @s enemydummy matches 2..5 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:157}},{}]}
execute if score @s enemydummy matches 6..9 if entity @p[distance=..10] unless entity @s[tag=icerodfrozen] run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:156}},{}]}
