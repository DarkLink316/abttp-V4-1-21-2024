...
execute if score @s dummy matches 0 if score @s enemydummy5 matches 1..3 run data merge entity @s {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:118}}}
execute if score @s dummy matches 0 if score @s enemydummy5 matches 4..6 run data merge entity @s {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:119}}}
...
execute if score @s dummy matches 0 if score @s enemydummy6 matches 0 run data merge entity @s {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:117}}}

execute if score @s dummy matches 1 run data merge entity @s {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:120}}}
