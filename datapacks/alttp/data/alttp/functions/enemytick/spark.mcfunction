...
execute if score @s enemydummy3 matches 1..2 run data merge entity @e[type=item_display,tag=sparkdi,limit=1,sort=nearest] {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:241}}}
execute if score @s enemydummy3 matches 3..4 run data merge entity @e[type=item_display,tag=sparkdi,limit=1,sort=nearest] {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:242}}}
execute if score @s enemydummy3 matches 5..6 run data merge entity @e[type=item_display,tag=sparkdi,limit=1,sort=nearest] {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:243}}}
execute if score @s enemydummy3 matches 7..8 run data merge entity @e[type=item_display,tag=sparkdi,limit=1,sort=nearest] {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:244}}}
execute if score @s enemydummy3 matches 9..10 run data merge entity @e[type=item_display,tag=sparkdi,limit=1,sort=nearest] {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:245}}}
execute if score @s enemydummy3 matches 11..12 run data merge entity @e[type=item_display,tag=sparkdi,limit=1,sort=nearest] {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:246}}}
