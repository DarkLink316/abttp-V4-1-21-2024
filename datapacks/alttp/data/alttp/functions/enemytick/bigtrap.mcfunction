...
execute if score @s enemydummy3 matches ..99 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:256}},{}]}
execute if score @s enemydummy3 matches 100 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:257}},{}]}
execute if score @s enemydummy3 matches 101 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:258}},{}]}
execute if score @s enemydummy3 matches 102 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:259}},{}]}
execute if score @s enemydummy3 matches 103 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:260}},{}]}
execute if score @s enemydummy3 matches 104 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:261}},{}]}
execute if score @s enemydummy3 matches 105 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:262}},{}]}