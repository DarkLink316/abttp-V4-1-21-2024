...
execute if score @s enemydummy5 matches 1..5 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:113}},{}]}
execute if score @s enemydummy5 matches 6..10 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:114}},{}]}
