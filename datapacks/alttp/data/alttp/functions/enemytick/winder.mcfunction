...
execute as @e[type=armor_stand,tag=winder_di] if score @s enemydummy3 matches 1..2 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:265}},{}]}
execute as @e[type=armor_stand,tag=winder_di] if score @s enemydummy3 matches 3..4 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:266}},{}]}
execute as @e[type=armor_stand,tag=winder_di] if score @s enemydummy3 matches 5..6 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:267}},{}]}
execute as @e[type=armor_stand,tag=winder_di] if score @s enemydummy3 matches 7..8 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:268}},{}]}
execute as @e[type=armor_stand,tag=winder_di] if score @s enemydummy3 matches 9..10 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:269}},{}]}
execute as @e[type=armor_stand,tag=winder_di] if score @s enemydummy3 matches 11..12 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:270}},{}]}
