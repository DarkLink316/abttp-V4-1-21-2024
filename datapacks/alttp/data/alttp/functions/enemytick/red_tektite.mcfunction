...
#MODELS
execute at @s unless block ~ ~-0.1 ~ #gothrough run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:74}},{}]}
execute at @s if block ~ ~-0.1 ~ #gothrough run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:75}},{}]}
