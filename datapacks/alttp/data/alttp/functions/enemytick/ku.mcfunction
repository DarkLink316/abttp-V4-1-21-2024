...
execute if score @s dummy matches 40..60 if entity @p[distance=..12] run data merge entity @s {Invulnerable:0b,HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:32}},{}]}
