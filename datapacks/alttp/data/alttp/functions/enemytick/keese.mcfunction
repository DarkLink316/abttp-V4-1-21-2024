#FIND LINKED ENTITY
tag @s add link_a
execute as @e[type=silverfish,tag=keesesf] if score @s enemylink = @e[type=armor_stand,tag=keese,limit=1,sort=nearest] enemylink run tag @s add link_b
...
execute if score result rand matches 1 if score @s enemydummy matches 1.. facing entity @p feet rotated ~ ~15 if block ^ ^ ^0.5 #gothrough run tp @s ^ ^ ^0.2 ~ ~
execute if score result rand matches 2 if score @s enemydummy matches 1.. facing entity @p feet rotated ~ ~ if block ^ ^ ^0.5 #gothrough run tp @s ^ ^ ^0.2 ~ ~
execute if score result rand matches 3 if score @s enemydummy matches 1.. facing entity @p feet rotated ~ ~-15 if block ^ ^ ^0.5 #gothrough run tp @s ^ ^ ^0.2 ~ ~
execute if score result rand matches 4 if score @s enemydummy matches 1.. facing entity @p eyes rotated ~ ~15 if block ^ ^ ^0.5 #gothrough run tp @s ^ ^ ^0.2 ~ ~
execute if score result rand matches 5 if score @s enemydummy matches 1.. facing entity @p eyes rotated ~ ~ if block ^ ^ ^0.5 #gothrough run tp @s ^ ^ ^0.2 ~ ~
execute if score result rand matches 6 if score @s enemydummy matches 1.. facing entity @p eyes rotated ~ ~-15 if block ^ ^ ^0.5 #gothrough run tp @s ^ ^ ^0.2 ~ ~
