...
execute if score @s enemydummy matches 0 run data merge entity @s {HandItems:[{id:"minecraft:activator_rail",Count:1b,tag:{}},{}]}
...
#CRAWLING STATE
execute if score @s enemydummy matches 1 if block ~ ~ ~ #gothrough run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:32}},{}]}
