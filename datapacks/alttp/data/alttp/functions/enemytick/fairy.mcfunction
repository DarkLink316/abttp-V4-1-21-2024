...
execute if score @s animationtick matches 1..4 run data merge entity @s {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:110}}}
execute if score @s animationtick matches 5..8 run data merge entity @s {item:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:111}}}
