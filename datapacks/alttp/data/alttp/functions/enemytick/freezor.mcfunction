...
execute if score @s enemydummy matches 0 run data merge entity @s {HandItems:[{id:"minecraft:activator_rail",Count:1b,tag:{CustomModelData:32}},{}]}
...
execute if score @s enemydummy matches 35 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:32}},{}]}
...
#DAMAGE INDICATOR
execute if entity @e[type=zombie,tag=link_b,nbt={HurtTime:10s}] run particle block blue_ice ~ ~0.7 ~ 0 0 0 0.1 50 force
