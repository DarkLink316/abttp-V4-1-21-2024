...
# Visibility
execute as @e[type=armor_stand,tag=body_segment] if entity @s[tag=visible,tag=!angry] run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:167}},{}]}
execute as @e[type=armor_stand,tag=body_segment] if entity @s[tag=visible,tag=angry] run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:169}},{}]}
execute as @e[type=armor_stand,tag=body_segment] unless entity @s[tag=visible] run data merge entity @s {HandItems:[{id:"minecraft:air",Count:1b,tag:{CustomModelData:32}},{}]}
...
# Random attack
execute unless score @s enemydummy11 matches 3 if score @s enemydummy matches 50..140 as @e[type=armor_stand,tag=body_segment] at @s unless block ~ ~0.7 ~ #gothrough run particle block sand ~ ~0.7 ~ 1 0.2 1 0.2 30 force
...
execute if entity @e[type=slime,tag=hitbox,nbt={HurtTime:5s}] run particle block redstone_block ~ ~0.7 ~ 1.5 1.5 1.5 0.1 500 force
