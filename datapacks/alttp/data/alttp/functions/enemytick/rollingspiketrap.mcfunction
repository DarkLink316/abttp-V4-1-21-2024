...
execute if score @s enemydummy matches 1..2 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:22}},{}]}
execute if score @s enemydummy matches 3..4 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:23}},{}]}
