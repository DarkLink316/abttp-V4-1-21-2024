#FIND LINKED ENTITY
tag @s add link_a
execute as @e[type=silverfish,tag=green_stalfossf] if score @s enemylink = @e[type=armor_stand,tag=green_stalfos,limit=1,sort=nearest] enemylink run tag @s add link_b
