...
execute if score @s enemydummy matches 70 unless entity @s[tag=icerodfrozen] run summon armor_stand ~ ~-1.3 ~ {Marker:1b,Invisible:1b,Tags:["octorokrok","enemy"],ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;915944579,617759624,-1509214886,1134866540],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjhkODE4ZTY1ZWUzNmNkY2FiNmUzMTVmNDk5ZDNmNWRkZTIzMjNiZjJkZjU2ZjFlOTE0MDg5Y2ViZWZhMzdmNiJ9fX0="}]}}}}]}
...
execute if score @s enemydummy matches 80 unless entity @s[tag=icerodfrozen] run summon armor_stand ~ ~-1.3 ~ {Marker:1b,Invisible:1b,Tags:["octorokrok","enemy"],ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;915944579,617759624,-1509214886,1134866540],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjhkODE4ZTY1ZWUzNmNkY2FiNmUzMTVmNDk5ZDNmNWRkZTIzMjNiZjJkZjU2ZjFlOTE0MDg5Y2ViZWZhMzdmNiJ9fX0="}]}}}}]}
