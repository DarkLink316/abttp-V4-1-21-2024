...
execute at @s if score @s enemydummy matches 74.. if block ~ ~-0.05 ~ #gothrough run tp @s ~ ~-0.05 ~
execute at @s if score @s enemydummy matches 74.. if block ~ ~-0.05 ~ #gothrough run tp @s ~ ~-0.05 ~
execute if score @s enemydummy matches 75.. run data merge entity @s {HandItems:[{id:"minecraft:activator_rail",Count:1b,tag:{}}]}
execute if score @s enemydummy matches 75.. run data merge entity @e[type=silverfish,tag=link_b,limit=1] {Invulnerable:1b}
execute if score @s enemydummy matches 120.. run particle block green_concrete_powder ~ ~ ~ 0 0 0 0.1 10
execute if score @s enemydummy matches 134.. run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:32}},{}]}
