...
execute if score @s enemydummy matches 20 at @e[type=drowned,tag=link_b,limit=1,sort=nearest] run summon snowball ~ ~2.5 ~ {Item:{id:"minecraft:activator_rail",Count:1b},Tags:["aggroball"]}
...
#DAMAGE INDICATOR
execute if entity @e[type=drowned,tag=link_b,nbt={HurtTime:10s}] run particle block redstone_block ~ ~0.7 ~ 0 0 0 0.1 50 force
