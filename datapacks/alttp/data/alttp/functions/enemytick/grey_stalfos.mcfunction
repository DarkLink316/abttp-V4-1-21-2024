#FIND LINKED ENTITY
tag @s add link_a
execute as @e[type=zombie,tag=grey_stalfoszo] if score @s enemylink = @e[type=armor_stand,tag=grey_stalfos,limit=1,sort=nearest] enemylink run tag @s add link_b
...
#DAMAGE INDICATOR
execute if score @s enemydummy matches ..-1 if entity @e[type=zombie,tag=link_b,nbt={HurtTime:10s}] run particle block redstone_block ~ ~0.7 ~ 0 0 0 0.1 50 force
...
execute if score @s enemydummy7 matches 0 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:195}},{}]}
...
execute if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 1..4 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:196}},{}]}
execute if score @s enemydummy7 matches 1 if score @s enemydummy10 matches 5..8 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:197}},{}]}
...
execute if score @s enemydummy matches ..-1 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:201}},{}]}

execute if score @s enemydummy matches 105..110 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:198}},{}]}
execute if score @s enemydummy matches 111..116 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:199}},{}]}
execute if score @s enemydummy matches 117..119 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:200}},{}]}
execute if score @s enemydummy matches 120.. run function alttp:gs_throwhead
...
#Pile
execute if score @s enemydummy2 matches 1.. run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:204}},{}]}
