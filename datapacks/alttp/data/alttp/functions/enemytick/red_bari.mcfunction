...
#IDLE
execute if score @s animationtick matches 0..2 if score @s enemydummy matches ..200 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:99}},{}]}
execute if score @s animationtick matches 3..5 if score @s enemydummy matches ..200 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:98}},{}]}
execute if score @s animationtick matches 6..8 if score @s enemydummy matches ..200 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:100}},{}]}

#CHARGING
execute if score @s enemydummy matches 201..240 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:101}},{}]}

#CHARGED
execute if score @s animationtick matches 0..1 if score @s enemydummy matches 240.. run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:102}},{}]}
execute if score @s animationtick matches 2..3 if score @s enemydummy matches 240.. run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:103}},{}]}
execute if score @s animationtick matches 4..5 if score @s enemydummy matches 240.. run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:102}},{}]}
execute if score @s animationtick matches 6..7 if score @s enemydummy matches 240.. run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:103}},{}]}
