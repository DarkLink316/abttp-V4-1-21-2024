...
summon item ~ ~1.3 ~ {PickupDelay:32767,Tags:["dothrowbomb"],Item:{id:"minecraft:tnt",Count:1b,tag:{activebomb:1,display:{Name:'{"text":"Bomb","color":"blue","italic":false}',Lore:['{"text":"Throw to place a bomb.","color":"white","italic":false}']},Enchantments:[{}]}}}
