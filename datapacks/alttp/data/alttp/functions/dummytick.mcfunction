...
execute if score @s enemydummy2 matches 1..3 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:87}},{}]}
execute if score @s enemydummy2 matches 4..6 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:88}},{}]}
