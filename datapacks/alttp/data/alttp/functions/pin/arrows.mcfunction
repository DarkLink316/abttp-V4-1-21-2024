...
execute unless score @s dummy = arrowselectamount dummy run clear @s ender_eye{CustomModelData:2}
execute unless score @s dummy = arrowselectamount dummy run clear @s ender_eye{CustomModelData:3}
execute unless score @s dummy = arrowselectamount dummy run clear @s ender_eye{CustomModelData:4}
execute unless score @s dummy = arrowselectamount dummy run clear @s ender_eye{CustomModelData:5}
execute unless score @s dummy = arrowselectamount dummy run clear @s ender_eye{CustomModelData:6}
...
execute if score @s arrows_selected matches 0 run item replace entity @s hotbar.8 with barrier{display:{Name:'{"text":"Out of arrows!","color":"red","italic":false}'},CustomModelData:1} 1
