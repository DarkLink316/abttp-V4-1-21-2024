...
tp @s ^ ^ ^1
execute at @s unless entity @p[distance=..5] facing entity @p eyes run tp @s ^ ^ ^0.2
execute at @s unless entity @p[distance=..5] facing entity @p eyes run tp @s ^ ^ ^0.2
execute at @s unless entity @p[distance=..5] facing entity @p eyes run tp @s ^ ^ ^0.2
execute at @s unless entity @p[distance=..5] facing entity @p eyes run tp @s ^ ^ ^0.2
execute at @s unless entity @p[distance=..5] facing entity @p eyes run tp @s ^ ^ ^0.2
...
execute store result entity @s Motion[0] double 0.00025 run scoreboard players get %dx g_vec
execute store result entity @s Motion[1] double 0.0015 run scoreboard players get %dy g_vec
execute store result entity @s Motion[2] double 0.00025 run scoreboard players get %dz g_vec
