...
item replace entity @s inventory.0 with structure_void
item replace entity @s inventory.1 with structure_void
item replace entity @s inventory.2 with structure_void
item replace entity @s inventory.3 with structure_void
item replace entity @s inventory.4 with structure_void
item replace entity @s inventory.5 with structure_void
item replace entity @s inventory.6 with structure_void
item replace entity @s inventory.7 with structure_void
item replace entity @s inventory.8 with structure_void
item replace entity @s inventory.9 with structure_void
item replace entity @s inventory.10 with structure_void
item replace entity @s inventory.11 with structure_void
item replace entity @s inventory.12 with structure_void
item replace entity @s inventory.13 with structure_void
item replace entity @s inventory.14 with structure_void
item replace entity @s inventory.15 with structure_void
item replace entity @s inventory.16 with structure_void
item replace entity @s inventory.17 with structure_void
item replace entity @s inventory.18 with structure_void
item replace entity @s inventory.19 with structure_void
item replace entity @s inventory.20 with structure_void
item replace entity @s inventory.21 with structure_void
item replace entity @s inventory.22 with structure_void
item replace entity @s inventory.23 with structure_void
item replace entity @s inventory.24 with structure_void
item replace entity @s inventory.25 with structure_void
item replace entity @s inventory.26 with structure_void
