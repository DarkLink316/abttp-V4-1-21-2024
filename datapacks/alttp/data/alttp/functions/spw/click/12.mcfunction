...
clear @s carrot_on_a_stick{display:{Name:'{"text":"Quake Medallion","color":"yellow","italic":false}',Lore:['{"text":"Jump high and rumble the ground!","color":"white","italic":false}']},CustomModelData:14}
