...
clear @s carrot_on_a_stick{display:{Name:'{"text":"Ice Rod","color":"#009FAB","italic":false}',Lore:['{"text":"Right-click to create an iceball.","color":"white","italic":false}']},CustomModelData:2}
