scoreboard players set @s dummy 9
...
clear @s carrot_on_a_stick{display:{Name:'{"text":"Flute","color":"blue","italic":false}',Lore:['{"text":"Sing the Flute boy\'s song","color":"white","italic":false}']},CustomModelData:11}
