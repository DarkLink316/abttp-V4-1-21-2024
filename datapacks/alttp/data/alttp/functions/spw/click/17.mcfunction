scoreboard players set @s dummy 17
...
clear @s carrot_on_a_stick{display:{Name:'{"text":"Cane of Byrna","color":"blue","italic":false}',Lore:['{"text":"Right-click to toggle forcefield!","color":"white","italic":false}']},CustomModelData:61} 1
