...
clear @s carrot_on_a_stick{display:{Name:'{"text":"Magic Cape","color":"red","italic":false}',Lore:['{"text":"Right-click to turn invisible!","color":"white","italic":false}']},CustomModelData:58} 1
