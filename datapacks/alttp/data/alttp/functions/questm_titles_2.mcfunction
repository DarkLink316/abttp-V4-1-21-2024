...
##Descriptions
execute if score sselectt dummy matches 1 run data merge entity @s {text:'{"text":"Apple delivery","color":"black"}'}
execute if score sselectt dummy matches 2 run data merge entity @s {text:'{"text":"Boy Link!","color":"black"}'}
execute if score sselectt dummy matches 3 run data merge entity @s {text:'{"text":"A test of navigation","color":"black"}'}
execute if score sselectt dummy matches 4 run data merge entity @s {text:'{"text":"A test of agility","color":"black"}'}
execute if score sselectt dummy matches 5 run data merge entity @s {text:'{"text":"A test of knowledge","color":"black"}'}
execute if score sselectt dummy matches 6 run data merge entity @s {text:'{"text":"A cat that\'s stuck","color":"black"}'}
execute if score sselectt dummy matches 7 run data merge entity @s {text:'{"text":"A town filled with muck","color":"black"}'}