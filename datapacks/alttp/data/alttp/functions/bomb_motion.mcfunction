...
execute store result entity @s Motion[0] double 0.001 run scoreboard players get %dx g_vec
execute store result entity @s Motion[1] double 0.001 run scoreboard players get %dy g_vec
execute store result entity @s Motion[2] double 0.001 run scoreboard players get %dz g_vec
