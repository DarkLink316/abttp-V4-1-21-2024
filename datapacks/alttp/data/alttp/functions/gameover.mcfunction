...
execute if entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{display:{Name:'{"text":"Fairy Bottle","color":"dark_gray","italic":false}',Lore:['{"text":"Right-click to release it!","color":"white","italic":false}']},CustomModelData:48}}]}] run scoreboard players set @s dummy 69
